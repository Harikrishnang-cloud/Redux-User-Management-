    ...
    return (
        <div>
            <nav className="bg-green-900 text-white p-4 flex justify-between items-center shadow-md">
                <h1 className="text-xl font-bold">Welcome to Nephro❤️Care</h1>
                <div className="space-x-4">
                    ...
                    <button className="hover:bg-green-800 px-3 py-1 rounded-lg" onClick={()=>navigate('/services')}>Services</button>
                    <button onClick={logout}className=" hover:bg-green-800 px-3 py-1 rounded-lg">Logout</button>
                </div>
            </nav>
        </div>
    )
